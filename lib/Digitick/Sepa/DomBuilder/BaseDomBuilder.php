...
{
    /**
	 * List of currencies not supporting deicmals
	 * 
	 * @array CURRENCIES_WITHOUT_DECIMAL
	 */
	public const CURRENCIES_WITHOUT_DECIMAL = [
		'JPY',
		'VND',
		'KRW'
	];
     ...
     */
    protected function intToCurrency($amount, $currency = null)
    {
        // Do not format amount with decimal for currencies not supporting it
