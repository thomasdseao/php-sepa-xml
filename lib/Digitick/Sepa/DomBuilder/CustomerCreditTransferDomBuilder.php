...
use Thomasdseao\Sepa\TransferInformation\CustomerCreditTransferInformation;
...
class CustomerCreditTransferDomBuilder extends BaseDomBuilder
{
    ...
    public function visitTransferInformation(TransferInformationInterface $transactionInformation)
    {
        ...
        $instructedAmount = $this->createElement(
            'InstdAmt',
            $this->intToCurrency($transactionInformation->getTransferAmount(), $transactionInformation->getCurrency())
        );
        ...
        $id = $this->createElement('Id');
        if($transactionInformation->getIban() === null) {
            $idAccountNumber = $this->createElement('Id', $transactionInformation->getAccountNumber());
	        $othrAccountNumber = $this->createElement('Othr');
	        $othrAccountNumber->appendChild($idAccountNumber);
	        $id->appendChild($othrAccountNumber);
        } else {
